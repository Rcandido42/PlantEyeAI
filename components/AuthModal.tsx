      ...
      <div className="bg-white rounded-[2rem] p-8 w-full max-w-sm shadow-2xl">
        <div className="flex items-center gap-3 mb-8">
          <div className="border-[3px] border-[#064E3B] px-2 py-0.5 flex items-center gap-0.5">
            ...
            <span className="text-xl font-black text-[#064E3B]">NT</span>
          </div>
        ...
        <div className="space-y-3">
          <div className="relative">
            <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-emerald-600/50" />
            <input
              type="email"
              placeholder="Email"
              value={email}
              onChange={e => setEmail(e.target.value)}
              className="w-full pl-11 pr-4 py-3 rounded-xl border border-emerald-100 bg-emerald-50/50 text-[#064E3B] text-sm font-medium outline-none focus:border-emerald-400 transition-colors"
            />
          </div>
          <div className="relative">
            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-emerald-600/50" />
            <input
              type="password"
        ...
        <button
          ...
          className="mt-5 w-full bg-[#064E3B] text-white py-3.5 rounded-xl font-black text-sm tracking-wide disabled:opacity-50 flex items-center justify-center gap-2 hover:bg-emerald-800 transition-colors"
        >
        ...
        <button
          ...
          className="mt-4 w-full text-center text-xs text-emerald-700/50 hover:text-emerald-700 font-medium transition-colors"
        >
